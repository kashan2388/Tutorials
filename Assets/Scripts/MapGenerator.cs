...
public class MapGenerator : MonoBehaviour
{
	...
	Queue<Coord> shuffledTileCoords; //랜덤으로 맵 상의 어떤 타일의 좌표를 가져오기위해 
	...
	public void GenerateMap() 
	{
		...
		shuffledTileCoords = new Queue<Coord>(Utility.ShuffleArray(allTileCoords.ToArray(), currentMap.seed)); //모든 타일의 좌표를 뒤섞기 위해 사용
		...
		shuffledOpenTileCoords = new Queue<Coord>(Utility.ShuffleArray(allOpenCoords.ToArray(), currentMap.seed)); //모든 타일의 좌표를 뒤섞기 위해 사용
